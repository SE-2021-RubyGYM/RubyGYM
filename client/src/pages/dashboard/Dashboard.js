          ...
          <Widget className="widget-p-lg">
            <div className="d-flex">
              ...
              <div className={s.adminInfo}>
                <p className="headline-3">{adminInfo.name}</p>
                <p className="body-3 muted">Quản trị viên Ruby GYM</p>
              </div>
            </div>
            
            <div className={s.goals}>
              <div className={s.goalsTitle}>
                <p className="headline-3" style={{color:"#2128bf"}}>Thông tin cá nhân</p>
              </div>
              <div >
                <p className="body-2">Mã quản trị viên</p>
                <p className="body-3 muted">{adminInfo._id}</p>
              </div>
              <div >
                <p className="body-2"> Tên quản trị viên</p>
                <p className="body-3 muted">{adminInfo.name}</p>
              </div>
              <div >
                <p className="body-2"> Tên tài khoản</p>
                <p className="body-3 muted">{adminInfo.username}</p>
              </div>
              <div >
                <p className="body-2"> Số điện thoại</p>
                <p className="body-3 muted">{adminInfo.phone}</p>
              </div>
              <div >
                <p className="body-2"> Ngày sinh</p>
                <p className="body-3 muted">{adminInfo.birthDay}</p>
              </div>
