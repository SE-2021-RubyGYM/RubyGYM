...
import { getCoachList, deleteCoachById, createUser } from "./api/api";
          ...
          <Row className="filter__root">
            ...
            <div className="filter__options" style={{ marginRight: "600px" }}>
              ...
              >
                ...
                {coachs.status.map((element, index) => {
              ...
              >
                ...
                {coachs.types.map((element, index) => {
                  return <option value={element}>{element}</option>;
                })}
              </select>
              <select
              ...
              >
                ...
                {coachs.assignees.map((element, index) => {
                  return <option value={element}>{element}</option>;
                })}
              </select>

              {/* <SelectCrm title={"Trạng thái HLV"} />
              <SelectCrm title={"Người quản lý"} />
              <SelectCrm title={"Nhóm HLV"} /> */}
            </div>
          </Row>
          <Row className="mb-4">
            <Col>
