  ...
  .e-footer-content {
    ...
    @if $skin-name == 'bootstrap5' or $skin-name == 'tailwind' or $skin-name == 'FluentUI' {
      .e-btn.e-primary.e-flat {
        background-color: $dialog-footer-btn-bg-color;
        border-color: $dialog-footer-btn-border-color;
        color: $dialog-footer-btn-color;
      }

      .e-btn:hover.e-primary.e-flat {
        background-color: $dialog-footer-hover-btn-color;
      }
    }

    @if $skin-name == 'bootstrap5' or $skin-name == 'tailwind' or $skin-name == 'FluentUI' {
      .e-btn.e-flat {
        background-color: $dialog-footer-flat-btn-bg-color;
        border-color: $dialog-footer-flat-btn-border-color;
        color: $dialog-footer-flat-btn-content-color;
      }

      .e-btn:hover.e-flat {
        background-color: $dialog-footer-flat-hover-btn-bg-color;
      }
    }
  }
